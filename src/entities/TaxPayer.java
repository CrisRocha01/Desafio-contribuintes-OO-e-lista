...
public class TaxPayer {
	...
	public double salaryTax() {
		if(getSalaryIncome() < 3000.0) {
			return 0.00;
		} else if (getSalaryIncome() >= 3000.0 && getSalaryIncome() < 5000.0) {
	...
	public double taxRebate() {
		double spendings = getHealthSpending() + getEducationSpending();
		if(grossTax() * 0.30 < spendings) {
